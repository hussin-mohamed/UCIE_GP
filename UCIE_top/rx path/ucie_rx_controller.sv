module ucie_rx_controller #(
    ...
    logic l2b_enable;
    logic l2b_enable_anded;
    assign l2b_enable = !i_fifo_empty ^ !empty ;
    assign l2b_enable_anded = (empty1 != l2b_enable);
    // Main control decode:
    ...
    always_comb begin
        ...
        if (eye_tx_uses_lfsr || eye_rx_uses_lfsr) begin
            ...
            o_fifo_rd_en        = 16'hffff; // Keep FIFO read enabled during LFSR-based eye patterns to feed data into the pattern generator
            end
        ...
        // ACTIVE keeps LFSR enabled for scrambling but disables train mode.
         if (i_rx_encoding == ENC_ACTIVE) begin
            ...
            if (!i_fifo_empty) begin
                ...
                if (l2b_enable_anded) begin
                     o_l2b_enable   = 1'b0;
                end
                else if (l2b_enable) begin
                    o_l2b_enable   = 1'b0;
                end
                else begin
                    o_l2b_enable   = 1'b1;
