...
module ucie_ltsm_rx_mbinit_repairval #(
    ...
    // Pattern detection results from RX PHY path (2 data lane health bits)
    ...
    always_comb begin
        ...
        if (o_timer_8ms) begin
            ...
            case (current_substate)
                ...
                SEND_RESP: begin
                    o_rx_encoding   = 9'h2A;
                    o_rx_info[1:0]  = i_pattern_detection_results_reg[1:0]; // 2 data lanes
                    o_rx_sb_rsp     = 1;
...
`ifdef SIM
    ...
    property result_latched;
        ...
        |-> (o_rx_info[1:0] === i_pattern_detection_results_reg[1:0]);
    endproperty
