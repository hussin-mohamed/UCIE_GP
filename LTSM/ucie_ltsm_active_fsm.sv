...
module ucie_ltsm_active_fsm #(
    ...
    output logic l1_tx_speed_idle_en,
  ...
  // Next-state logic
  // =========================================================================
  logic raw_done_retrain, raw_done_l1_rx, raw_done_l1_tx, raw_done_linkreset, raw_done_linkerror;
  ...
  always_comb begin
    ...
    case (current_state)
      ...
      LINKINIT: begin
        ...
        if (
            (done_tx_linkinit && raw_done_rx_linkinit) ||
            (done_rx_linkinit && raw_done_tx_linkinit) ||
            (done_tx_linkinit && done_rx_linkinit) ||
            (raw_done_tx_linkinit && raw_done_rx_linkinit)
        )
          next_state = ACTIVE;
      end
      ...
      ACTIVE: begin
        ...
        else if (raw_done_l1_rx || raw_done_l1_tx) next_state = L1;
      ...
      L1: begin
        ...
        else if ((done_tx_l1_active && l1_rx_active_en) ||
                 (done_rx_l1_active && l1_tx_active_en) ||
                 (done_tx_l1_active && done_rx_l1_active) ||
                 (l1_rx_active_en && l1_tx_active_en) || l1_tx_active_en)
  ...
  ucie_ltsm_active u_active (
      ...
      .o_done_active_l1_tx    (raw_done_l1_tx),
      .o_done_active_l1_rx    (raw_done_l1_rx),
  ...
  // =========================================================================
  // Sub-module: L1 TX                                        
  // Enabled by raw_done_l1_rx || raw_done_l1_tx from the active module.
  ...
  ucie_LTSM_rx_L1 #(
      ...
      .i_reset                (i_reset),
      .i_rx_decoding          (i_rx_decoding),
      .i_rx_decoding_old      (o_rx_encoding),
      .i_lp_state_req         (i_lp_state_req),
      .i_sb_rx_req            (i_sb_rx_req),
      .i_sb_rx_rsp            (i_sb_rx_rsp),
      .i_sb_rx_done           (i_sb_rx_done),
      .state_enable           (raw_done_l1_rx),
  ...
  assign o_done_active_l1 = raw_done_l1_rx || raw_done_l1_tx;
