...
module ucie_ltsm_linkinit_tx (
    ...
    always_ff @(posedge i_clk or posedge i_reset) begin
        if (i_reset) begin
            ...
            if (current_substate == CLK_REQ_HS && i_lp_clk_ack)
                clk_ack_seen <= 1'b1;
    ...
    always_comb begin
        ...
        if (i_current_state == LINKINIT && !substates_done) begin
            ...
            if (o_timer_8ms) begin
                ...
                case (current_substate)
                    ...
                    STATE_REQ_HS: begin
                        ...
                        if (i_sb_tx_rsp && (i_tx_decoding == 9'h102) && done_ack)
                            o_done_linkinit_tx = 1'b1;
                    end
