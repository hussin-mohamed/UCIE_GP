# =============================================================================
# File       : compile_only.do
# Description: Compile and optimize only (no simulation).
#              Run once, then use sim_only.do for fast re-runs.
#
# Usage (from UCIE_top_env/sim):
#   vsim -c -do "set UCIE_SYS_LVL 1; do compile_only.do"
# =============================================================================
...
# 11. Elaborate / optimize (no simulation)
vopt +acc ucie_tb_top -o opt_ucie_tb_top

echo ""
echo "=== Compile complete. Run sim_only.do to simulate. ==="
echo ""
