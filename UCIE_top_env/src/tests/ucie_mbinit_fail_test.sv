//=============================================================================
// File       : ucie_mbinit_fail_test.sv
// Project    : UCIe 3.0 System-Level Verification
// Description: Sanity test that runs the master virtual sequence.
//=============================================================================

class ucie_mbinit_fail_test extends ucie_base_test;

  `uvm_component_utils(ucie_mbinit_fail_test)

  // -------------------------------------------------------------------------
  //  Constructor
  // -------------------------------------------------------------------------
  function new(string name = "ucie_mbinit_fail_test", uvm_component parent = null);
    super.new(name, parent);
    uvm_top.set_timeout(350ms, 0);
  endfunction
...
endclass : ucie_mbinit_fail_test
