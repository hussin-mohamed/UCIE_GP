//=============================================================================
// File       : ucie_mbinit_fail_clk_test.sv
// Project    : UCIe 3.0 System-Level Verification
// Description: Test setting up the system environment and starting
//              ucie_mbinit_fail_vseq configured for FAIL_CLK on FAIL_SIDE_RX.
//=============================================================================

class ucie_mbinit_fail_clk_test extends ucie_base_test;

  `uvm_component_utils(ucie_mbinit_fail_clk_test)

  // -------------------------------------------------------------------------
  //  Constructor
  // -------------------------------------------------------------------------
  function new(string name = "ucie_mbinit_fail_clk_test", uvm_component parent = null);
  ...
  virtual function void start_of_simulation_phase(uvm_phase phase);
    ...
    if ($cast(fail_vseq, vseq)) begin
      fail_vseq.configure(FAIL_CLK, FAIL_SIDE_RX);
    end else begin
      `uvm_fatal("TEST_CFG_ERR", "Failed to cast vseq to ucie_mbinit_fail_vseq")
    end
  endfunction : start_of_simulation_phase

endclass : ucie_mbinit_fail_clk_test
