...
package ucie_pkg;
  ...
  `include "ucie_mbtrain_till_DTC1_vseq.sv"
  `include "ucie_mbtrain_till_datatrainvref_vseq.sv"
  `include "ucie_mbtrain_till_DTC2_vseq.sv"
  ...
  `include "ucie_mbinit_fail_clk_test.sv"
  `include "ucie_mbinit_fail_val_test.sv"
  `include "ucie_mbinit_fail_reversal_test.sv"
  `include "ucie_mbinit_fail_repair_tx_test.sv"
  `include "ucie_mbinit_fail_repair_rx_test.sv"
