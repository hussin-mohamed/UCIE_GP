//=============================================================================
// File       : ucie_mbtrain_valverf_vseq.sv
...
class ucie_mbtrain_valverf_vseq extends ucie_vseq_base;

  `uvm_object_utils(ucie_mbtrain_valverf_vseq)

  // -------------------------------------------------------------------------
  //  Constructor
  // -------------------------------------------------------------------------
  function new(string name = "ucie_mbtrain_valverf_vseq");
    super.new(name);
  endfunction
  ...
  endtask
endclass : ucie_mbtrain_valverf_vseq
