//=============================================================================
// File       : ucie_mbtrain_till_DTC2_vseq.sv
...
class ucie_mbtrain_till_DTC2_vseq extends ucie_vseq_base;

  `uvm_object_utils(ucie_mbtrain_till_DTC2_vseq)
  ...
  //  Constructor
  // -------------------------------------------------------------------------
  function new(string name = "ucie_mbtrain_till_DTC2_vseq");
    super.new(name);
  endfunction
  ...
  endtask
endclass : ucie_mbtrain_till_DTC2_vseq
