...
class rx_fsm_sb_sequence_item extends uvm_sequence_item;
    ...
    `uvm_object_utils_begin(rx_fsm_sb_sequence_item)
        ...
        `uvm_field_int(o_sbinit_start,  UVM_NORECORD)
        `uvm_field_int(i_sb_rx_req,     UVM_NORECORD)
        `uvm_field_int(i_sb_rx_rsp,     UVM_NORECORD)
        `uvm_field_int(i_sb_rx_done,    UVM_NORECORD)
        `uvm_field_int(o_rx_sb_req,     UVM_NORECORD)
        `uvm_field_int(o_rx_sb_rsp,     UVM_NORECORD)
        `uvm_field_int(o_rx_sb_done,    UVM_NORECORD)
