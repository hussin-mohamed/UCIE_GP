...
//------------------------------------------------------------------------------
//
// CLASS: LTSM_test_base
//
// The LTSM_test_base class provides common test infrastructure for the
...
class LTSM_test_base extends uvm_test;
    `uvm_component_utils(LTSM_test_base)
    ...
    // Function: new
    //
    // Creates a new LTSM_test_base instance and retrieves factory singleton handle.

    extern function new(string name = "LTSM_test_base", uvm_component parent = null);
...
function LTSM_test_base::new(string name = "LTSM_test_base", uvm_component parent = null);
...
function void LTSM_test_base::build_phase(uvm_phase phase);
...
function void LTSM_test_base::end_of_elaboration_phase(uvm_phase phase);
...
function void LTSM_test_base::start_of_simulation_phase(uvm_phase phase);
...
task LTSM_test_base::run_phase(uvm_phase phase);
...
function void LTSM_test_base::final_phase(uvm_phase phase);
