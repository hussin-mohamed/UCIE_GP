...
class timeout_pat_gen_test extends svaunit_test;
  ...
  function new(string name = "timeout_pat_gen_test", uvm_component parent);
  ...
  // ========================================================================
  // REUSABLE ATTEMPT TASK
  // Evaluates either the Timeout Scenario or the Success Scenario
  // ========================================================================
  task run_init_attempt(bit inject_timeout);
    int ms_count = 0;
    int tx_bit_idx = 0;
