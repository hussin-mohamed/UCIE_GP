...
class rx_sb_monitor #(type ITEM_T, type INTF_T) extends sb_monitor_base #(ITEM_T, INTF_T);
    `uvm_component_param_utils(rx_sb_monitor #(ITEM_T, INTF_T))
...
task rx_sb_monitor::collect_transaction();
