...
function void tx_sb_agent::build_phase(uvm_phase phase);
    ...
    set_type_override_by_type ( tx_path_driver::get_type(), tx_sb_driver#(virtual sb_tx_path_bfm)::get_type() );
    set_type_override_by_type ( tx_sb_sequencer::get_type(), tx_sb_sequencer#(tx_sequence_item)::get_type() );
    set_type_override_by_type ( tx_path_monitor::get_type(), tx_sb_monitor#(tx_sequence_item, virtual sb_tx_path_bfm)::get_type() );
