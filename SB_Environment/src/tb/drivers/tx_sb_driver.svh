...
class tx_sb_driver #(type INTF_T) extends sb_driver_base #(tx_sequence_item, INTF_T);
    `uvm_component_param_utils(tx_sb_driver#(INTF_T))
...
task tx_sb_driver::drive(APB_sequence_item_1 item);
