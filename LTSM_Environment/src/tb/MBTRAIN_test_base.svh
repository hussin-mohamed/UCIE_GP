...
//------------------------------------------------------------------------------
//
// CLASS: MBTRAIN_test_base
//
// The MBTRAIN_test_base class provides common test infrastructure for the
...
class MBTRAIN_test_base extends uvm_test;
    `uvm_component_utils(MBTRAIN_test_base)
    ...
    // Function: new
    //
    // Creates a new MBTRAIN_test_base instance and retrieves factory singleton handle.

    extern function new(string name = "MBTRAIN_test_base", uvm_component parent = null);
...
function MBTRAIN_test_base::new(string name = "MBTRAIN_test_base", uvm_component parent = null);
...
function void MBTRAIN_test_base::build_phase(uvm_phase phase);
...
function void MBTRAIN_test_base::end_of_elaboration_phase(uvm_phase phase);
...
function void MBTRAIN_test_base::start_of_simulation_phase(uvm_phase phase);
...
task MBTRAIN_test_base::run_phase(uvm_phase phase);
    ...
    `uvm_info(get_type_name(), $sformatf("Starting sequence: %s", linkspeed_repair_fail_4_15.get_type_name()), UVM_MEDIUM)
    linkspeed_repair_fail_4_15.start(env.v_seqr);
    `uvm_info(get_type_name(), $sformatf("Finished sequence: %s", linkspeed_repair_fail_4_15.get_type_name()), UVM_MEDIUM)
    // txslefcal to linkspeed
    fork
        begin
             `uvm_info(get_type_name(), $sformatf("Starting sequence: %s", txselfcal_tx_end.get_type_name()), UVM_MEDIUM)
    ...
    `uvm_info(get_type_name(), $sformatf("Starting sequence: %s", linkspeed_repair_fail_0_3_8_15.get_type_name()), UVM_MEDIUM)
    linkspeed_repair_fail_0_3_8_15.start(env.v_seqr);
    `uvm_info(get_type_name(), $sformatf("Finished sequence: %s", linkspeed_repair_fail_0_3_8_15.get_type_name()), UVM_MEDIUM)
    // txslefcal to linkspeed
    fork
        begin
             `uvm_info(get_type_name(), $sformatf("Starting sequence: %s", txselfcal_tx_end.get_type_name()), UVM_MEDIUM)
...
function void MBTRAIN_test_base::final_phase(uvm_phase phase);
