...
class ltsm_mbinit_repiarmb_v_sequence extends virtual_sequence_base;
  ...
  virtual task body();
    ...
    ltsm_data2clk_result_exit_tx #(ALL_LANES_FUNCTIONAL) result_exit_tx;
    ltsm_mbinit_repairmb_degrade_setup_tx degrade_setup_tx;
    ltsm_mbinit_repairmb_degrade_exit_tx #(ALL_LANES_FUNCTIONAL) degrade_exit_tx;
    ...
    ltsm_mbinit_repairmb_degrage_checking_rx #(MATCHED) degrade_checking_rx;
    ...
    fork
      begin
        ...
        result_exit_tx = ltsm_data2clk_result_exit_tx#(ALL_LANES_FUNCTIONAL)::type_id::create("result_exit_tx");
        ...
        degrade_exit_tx = ltsm_mbinit_repairmb_degrade_exit_tx#(ALL_LANES_FUNCTIONAL)::type_id::create("degrade_exit_tx");
      ...
      begin
        ...
        degrade_checking_rx = ltsm_mbinit_repairmb_degrage_checking_rx#(MATCHED)::type_id::create("degrade_checking_rx");
