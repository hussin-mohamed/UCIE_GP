...
//------------------------------------------------------------------------------
//
// CLASS: ltsm_init_val_fail_v_sequence
//
// This virtual sequence is used to mimic the initialization flow with valid lane failure.
// 
//
//
//------------------------------------------------------------------------------

class ltsm_init_val_fail_v_sequence extends virtual_sequence_base;
    `uvm_object_utils(ltsm_init_val_fail_v_sequence)
    ...
    extern function new(string name = "ltsm_init_val_fail_v_sequence");
...
endclass : ltsm_init_val_fail_v_sequence
...
function ltsm_init_val_fail_v_sequence::new(string name = "ltsm_init_val_fail_v_sequence");
    super.new(name);
endfunction : new
...
task ltsm_init_val_fail_v_sequence::pre_body();
    // tx sequences
    ...
    repairval=ltsm_mbinit_repairval_fail_v_sequence::type_id::create("repairval");
    ...
    trainerror_v_seq = trainerror::type_id::create("trainerror_v_seq");
    repairval_pass = ltsm_mbinit_repairval_v_sequence::type_id::create("repairval_pass");
...
task ltsm_init_val_fail_v_sequence::body();
    super.body();
    reset.start(v_seqr);
    sbinit.start(v_seqr);
    param.start(v_seqr);
