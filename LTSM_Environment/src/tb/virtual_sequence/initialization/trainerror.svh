...
class trainerror extends virtual_sequence_base;
    `uvm_object_utils(trainerror)
    ...
    extern function new(string name = "trainerror");
...
function trainerror::new(string name = "trainerror");
    super.new(name);
endfunction : new
