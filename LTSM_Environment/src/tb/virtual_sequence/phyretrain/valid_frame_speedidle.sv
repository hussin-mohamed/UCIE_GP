...
class phyretrain_valid_frame_speedidle extends virtual_sequence_base;
    `uvm_object_utils(phyretrain_valid_frame_speedidle)
    ...
    extern function new(string name = "phyretrain_valid_frame_speedidle");
...
endclass : phyretrain_valid_frame_speedidle
...
function phyretrain_valid_frame_speedidle::new(string name = "phyretrain_valid_frame_speedidle");
    super.new(name);
endfunction : new
...
task phyretrain_valid_frame_speedidle::pre_body();
    // tx sequences
...
task phyretrain_valid_frame_speedidle::body();
    super.body();
