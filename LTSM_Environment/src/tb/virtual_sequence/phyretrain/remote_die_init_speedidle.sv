...
class phyretrain_remote_die_init_speedidle extends virtual_sequence_base;
    `uvm_object_utils(phyretrain_remote_die_init_speedidle)
    ...
    extern function new(string name = "phyretrain_remote_die_init_speedidle");
...
endclass : phyretrain_remote_die_init_speedidle
...
function phyretrain_remote_die_init_speedidle::new(string name = "phyretrain_remote_die_init_speedidle");
    super.new(name);
endfunction : new
...
task phyretrain_remote_die_init_speedidle::pre_body();
    // tx sequences
...
task phyretrain_remote_die_init_speedidle::body();
    super.body();
       fork
