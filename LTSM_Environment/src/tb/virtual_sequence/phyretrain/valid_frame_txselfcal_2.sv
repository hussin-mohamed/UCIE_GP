...
class phyretrain_valid_frame_txselfcal_2 extends virtual_sequence_base;
    `uvm_object_utils(phyretrain_valid_frame_txselfcal_2)
    phyretrain_rx_frame_error tx_frame_error_seq ;
    phyretrain_stallack tx_stall_seq ;
    phyretrain_tx_retr_hs tx_retrain_hs_seq ;
    phyretrain_reg_txself_2 tx_sent_txselfcal_2_seq ;
    phyretrain_tx_reqhs tx_req_hs_seq ;
    // rx sequences
    phyretrain_rx_retr_hs rx_retrain_hs_seq ;
    phyretrain_stallack rx_stall_seq ;
    phyretrain_reg_txself_2 rx_sent_txselfcal_2_seq ;
    ...
    extern function new(string name = "phyretrain_valid_frame_txselfcal_2");
...
endclass : phyretrain_valid_frame_txselfcal_2
...
function phyretrain_valid_frame_txselfcal_2::new(string name = "phyretrain_valid_frame_txselfcal_2");
    super.new(name);
endfunction : new
...
task phyretrain_valid_frame_txselfcal_2::pre_body();
    // tx sequences
    tx_frame_error_seq = phyretrain_rx_frame_error::type_id::create("tx_frame_error_seq");
    ...
    tx_sent_txselfcal_2_seq = phyretrain_reg_txself_2::type_id::create("tx_sent_txselfcal_seq");
    ...
    rx_sent_txselfcal_2_seq = phyretrain_reg_txself_2::type_id::create("rx_sent_txselfcal_seq");
