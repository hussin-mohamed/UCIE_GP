...
class phyretrain_rdi_init_txselfcal extends virtual_sequence_base;
    `uvm_object_utils(phyretrain_rdi_init_txselfcal)
    ...
    extern function new(string name = "phyretrain_rdi_init_txselfcal");
...
endclass : phyretrain_rdi_init_txselfcal
...
function phyretrain_rdi_init_txselfcal::new(string name = "phyretrain_rdi_init_txselfcal");
    super.new(name);
endfunction : new
...
task phyretrain_rdi_init_txselfcal::pre_body();
    // tx sequences
...
task phyretrain_rdi_init_txselfcal::body();
    super.body();
