...
class phyretrain_remote_die_init_txselfcal_2 extends virtual_sequence_base;
    `uvm_object_utils(phyretrain_remote_die_init_txselfcal_2)
    ...
    extern function new(string name = "phyretrain_remote_die_init_txselfcal_2");
...
endclass : phyretrain_remote_die_init_txselfcal_2
...
function phyretrain_remote_die_init_txselfcal_2::new(string name = "phyretrain_remote_die_init_txselfcal_2");
    super.new(name);
endfunction : new
...
task phyretrain_remote_die_init_txselfcal_2::pre_body();
    // tx sequences
    ...
    tx_sent_txselfcal_2_seq = phyretrain_reg_txself_2::type_id::create("tx_sent_txselfcal_2_seq");
    ...
    rx_sent_txselfcal_2_seq = phyretrain_reg_txself_2::type_id::create("rx_sent_txselfcal_2_seq");
...
task phyretrain_remote_die_init_txselfcal_2::body();
    super.body();
       fork
