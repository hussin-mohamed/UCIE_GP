...
class phyretrain_rdi_init_txselfcal_2 extends virtual_sequence_base;
    `uvm_object_utils(phyretrain_rdi_init_txselfcal_2)
    ...
    extern function new(string name = "phyretrain_rdi_init_txselfcal_2");
...
endclass : phyretrain_rdi_init_txselfcal_2
...
function phyretrain_rdi_init_txselfcal_2::new(string name = "phyretrain_rdi_init_txselfcal_2");
    super.new(name);
endfunction : new
...
task phyretrain_rdi_init_txselfcal_2::pre_body();
    // tx sequences
...
task phyretrain_rdi_init_txselfcal_2::body();
    super.body();
