...
class phyretrain_valid_frame_txselfcal extends virtual_sequence_base;
    ...
    extern function new(string name = "phyretrain_valid_frame_txselfcal");
...
endclass : phyretrain_valid_frame_txselfcal
...
function phyretrain_valid_frame_txselfcal::new(string name = "phyretrain_valid_frame_txselfcal");
    super.new(name);
endfunction : new
...
task phyretrain_valid_frame_txselfcal::pre_body();
    // tx sequences
    ...
    tx_sent_txselfcal_seq = phyretrain_reg_txself::type_id::create("tx_sent_txselfcal_seq");
    ...
    rx_sent_txselfcal_seq = phyretrain_reg_txself::type_id::create("rx_sent_txselfcal_seq");
...
task phyretrain_valid_frame_txselfcal::body();
    super.body();
