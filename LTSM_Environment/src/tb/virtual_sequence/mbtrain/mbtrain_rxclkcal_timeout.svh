...
class mbtrain_rxclkcal_timeout extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_rxclkcal_timeout)
    ...
    extern function new(string name = "mbtrain_rxclkcal_timeout");
...
endclass : mbtrain_rxclkcal_timeout
...
function mbtrain_rxclkcal_timeout::new(string name = "mbtrain_rxclkcal_timeout");
    super.new(name);
endfunction : new
...
task mbtrain_rxclkcal_timeout::pre_body();
    // tx sequences
...
task mbtrain_rxclkcal_timeout::body();
    super.body();
    fork
        // tx thread
        begin
