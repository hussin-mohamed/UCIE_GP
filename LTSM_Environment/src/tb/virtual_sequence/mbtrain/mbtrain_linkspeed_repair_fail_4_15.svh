...
class mbtrain_linkspeed_repair_fail_4_15 extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_linkspeed_repair_fail_4_15)
    ...
    mbtrain_txinit_datasweep_fail_4_15        data_sweep;

    // Function: new
    //
    // Creates a new virtual_sequence instance with the given name.

    extern function new(string name = "mbtrain_linkspeed_repair_fail_4_15");
...
endclass : mbtrain_linkspeed_repair_fail_4_15
...
function mbtrain_linkspeed_repair_fail_4_15::new(string name = "mbtrain_linkspeed_repair_fail_4_15");
    super.new(name);
endfunction : new
...
task mbtrain_linkspeed_repair_fail_4_15::pre_body();
    // tx sequences
    ...
    // datasweep sequence  
    data_sweep=mbtrain_txinit_datasweep_fail_4_15::type_id::create("data_sweep");
endtask

// body
// ----

task mbtrain_linkspeed_repair_fail_4_15::body();
    super.body();
    fork
        // tx thread
        begin
