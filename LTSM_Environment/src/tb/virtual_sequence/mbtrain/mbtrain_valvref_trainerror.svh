...
class mbtrain_valvref_trainerror extends virtual_sequence_base;
    ...
    extern function new(string name = "mbtrain_valvref_trainerror");
...
function mbtrain_valvref_trainerror::new(string name = "mbtrain_valvref_trainerror");
    super.new(name);
endfunction : new
...
task mbtrain_valvref_trainerror::body();
    super.body();
    fork
        // tx thread
        begin
