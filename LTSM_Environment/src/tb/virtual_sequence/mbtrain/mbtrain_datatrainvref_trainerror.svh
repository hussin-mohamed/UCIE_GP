...
class mbtrain_datatrainvref_trainerror extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_datatrainvref_trainerror)
    ...
    extern function new(string name = "mbtrain_datatrainvref_trainerror");
...
function mbtrain_datatrainvref_trainerror::new(string name = "mbtrain_datatrainvref_trainerror");
    super.new(name);
endfunction : new
...
task mbtrain_datatrainvref_trainerror::body();
    super.body();
    fork
        // tx thread
        begin
