...
class mbtrain_linkspeed_phyretrain_nolanepossible_rxfail extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_linkspeed_phyretrain_nolanepossible_rxfail)
    ...
    mbtrain_txinit_datasweep_txpass_rxallfail  data_sweep;

    // Function: new
    //
    // Creates a new virtual_sequence instance with the given name.

    extern function new(string name = "mbtrain_linkspeed_phyretrain_nolanepossible_rxfail");
...
endclass : mbtrain_linkspeed_phyretrain_nolanepossible_rxfail
...
function mbtrain_linkspeed_phyretrain_nolanepossible_rxfail::new(string name = "mbtrain_linkspeed_phyretrain_nolanepossible_rxfail");
    super.new(name);
endfunction : new
...
task mbtrain_linkspeed_phyretrain_nolanepossible_rxfail::pre_body();
    // tx sequences
...
task mbtrain_linkspeed_phyretrain_nolanepossible_rxfail::body();
    super.body();
    fork
        // tx thread
        begin
