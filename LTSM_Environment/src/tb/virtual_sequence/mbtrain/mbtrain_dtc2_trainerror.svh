...
class mbtrain_dtc2_trainerror extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_dtc2_trainerror)
    ...
    extern function new(string name = "mbtrain_dtc2_trainerror");
...
endclass : mbtrain_dtc2_trainerror
...
function mbtrain_dtc2_trainerror::new(string name = "mbtrain_dtc2_trainerror");
    super.new(name);
endfunction : new
...
task mbtrain_dtc2_trainerror::pre_body();
    // tx sequences
...
task mbtrain_dtc2_trainerror::body();
    super.body();
    fork
        // tx thread
        begin
