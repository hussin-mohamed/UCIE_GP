...
class mbtrain_dtc2_timeout extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_dtc2_timeout)
    ...
    extern function new(string name = "mbtrain_dtc2_timeout");
...
function mbtrain_dtc2_timeout::new(string name = "mbtrain_dtc2_timeout");
    super.new(name);
endfunction : new
...
task mbtrain_dtc2_timeout::pre_body();
    // tx sequences
...
task mbtrain_dtc2_timeout::body();
    super.body();
    fork
        // tx thread
        begin
