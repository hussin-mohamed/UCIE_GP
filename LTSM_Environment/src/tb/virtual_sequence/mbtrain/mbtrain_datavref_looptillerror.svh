...
class mbtrain_datavref_looptillerror extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_datavref_looptillerror)
    ...
    extern function new(string name = "mbtrain_datavref_looptillerror");
...
endclass : mbtrain_datavref_looptillerror
...
function mbtrain_datavref_looptillerror::new(string name = "mbtrain_datavref_looptillerror");
    super.new(name);
endfunction : new
...
task mbtrain_datavref_looptillerror::pre_body();
    // tx sequences
...
task mbtrain_datavref_looptillerror::body();
    super.body();
    fork
        // tx thread
        begin
