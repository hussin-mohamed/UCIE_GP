...
class mbtrain_rxclkcal_trainerror extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_rxclkcal_trainerror)
    ...
    extern function new(string name = "mbtrain_rxclkcal_trainerror");
...
endclass : mbtrain_rxclkcal_trainerror
...
function mbtrain_rxclkcal_trainerror::new(string name = "mbtrain_rxclkcal_trainerror");
    super.new(name);
endfunction : new
...
task mbtrain_rxclkcal_trainerror::pre_body();
    // tx sequences
...
task mbtrain_rxclkcal_trainerror::body();
    super.body();
    fork
        // tx thread
        begin
