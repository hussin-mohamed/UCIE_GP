...
class mbtrain_valvref_looptillerror extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_valvref_looptillerror)
    ...
    extern function new(string name = "mbtrain_valvref_looptillerror");
...
endclass : mbtrain_valvref_looptillerror
...
function mbtrain_valvref_looptillerror::new(string name = "mbtrain_valvref_looptillerror");
    super.new(name);
endfunction : new
...
task mbtrain_valvref_looptillerror::pre_body();
    // tx sequences
...
task mbtrain_valvref_looptillerror::body();
    super.body();
    fork
        // tx thread
        begin
