...
class mbtrain_success_speedidle extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_success_speedidle)
    ...
    extern function new(string name = "mbtrain_success_speedidle");
...
endclass : mbtrain_success_speedidle
...
function mbtrain_success_speedidle::new(string name = "mbtrain_success_speedidle");
    super.new(name);
endfunction : new
...
task mbtrain_success_speedidle::pre_body();
    // tx sequences
...
task mbtrain_success_speedidle::body();
    super.body();
