...
class mbtrain_datatrainvref_looptillerror extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_datatrainvref_looptillerror)
    ...
    extern function new(string name = "mbtrain_datatrainvref_looptillerror");
...
endclass : mbtrain_datatrainvref_looptillerror
...
function mbtrain_datatrainvref_looptillerror::new(string name = "mbtrain_datatrainvref_looptillerror");
    super.new(name);
endfunction : new
...
task mbtrain_datatrainvref_looptillerror::pre_body();
    // tx sequences
...
task mbtrain_datatrainvref_looptillerror::body();
    super.body();
    fork
        // tx thread
        begin
