...
class mbtrain_dtc2_success extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_dtc2_success)
    mbtrain_dtc2_tx_starthandshake            start_tx;
    mbtrain_dtc2_tx_endhandshake              end_handshake_tx;
    mbtrain_dtc2_rx_starthandshake            start_rx;
    mbtrain_dtc2_rx_endhandshake              end_handshake_rx;
    ...
    extern function new(string name = "mbtrain_dtc2_success");
...
function mbtrain_dtc2_success::new(string name = "mbtrain_dtc2_success");
    super.new(name);
endfunction : new
...
task mbtrain_dtc2_success::pre_body();
    // tx sequences
    start_tx=mbtrain_dtc2_tx_starthandshake::type_id::create("start_tx");
    end_handshake_tx=mbtrain_dtc2_tx_endhandshake::type_id::create("end_handshake_tx");
    // rx sequences
    start_rx=mbtrain_dtc2_rx_starthandshake::type_id::create("start_rx");
    end_handshake_rx=mbtrain_dtc2_rx_endhandshake::type_id::create("end_handshake_rx");
    // datasweep sequence  
...
task mbtrain_dtc2_success::body();
    super.body();
    fork
        // tx thread
        begin
