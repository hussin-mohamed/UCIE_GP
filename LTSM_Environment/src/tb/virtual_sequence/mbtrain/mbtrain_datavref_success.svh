...
class mbtrain_datavref_success extends virtual_sequence_base;
    ...
    extern function new(string name = "mbtrain_datavref_success");
...
endclass : mbtrain_datavref_success
...
function mbtrain_datavref_success::new(string name = "mbtrain_datavref_success");
    super.new(name);
endfunction : new
...
task mbtrain_datavref_success::pre_body();
    // tx sequences
    start_tx=mbtrain_datavref_tx_starthandshake::type_id::create("start_tx");
    end_handshake_tx=mbtrain_datavref_tx_endhandshake::type_id::create("end_handshake_tx");
    // rx sequences
...
task mbtrain_datavref_success::body();
    super.body();
    fork
        // tx thread
        begin
