...
class mbtrain_datatrainvref_success extends virtual_sequence_base;
    ...
    extern function new(string name = "mbtrain_datatrainvref_success");
...
endclass : mbtrain_datatrainvref_success
...
function mbtrain_datatrainvref_success::new(string name = "mbtrain_datatrainvref_success");
    super.new(name);
endfunction : new
...
task mbtrain_datatrainvref_success::pre_body();
    // tx sequences
    start_tx=mbtrain_datatrainvref_tx_starthandshake::type_id::create("start_tx");
    end_handshake_tx=mbtrain_datatrainvref_tx_endhandshake::type_id::create("end_handshake_tx");
    // rx sequences
...
task mbtrain_datatrainvref_success::body();
    super.body();
    fork
        // tx thread
        begin
