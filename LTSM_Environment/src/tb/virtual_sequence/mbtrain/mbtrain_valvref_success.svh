...
class mbtrain_valvref_success extends virtual_sequence_base;
    ...
    extern function new(string name = "mbtrain_valvref_success");
...
endclass : mbtrain_valvref_success
...
function mbtrain_valvref_success::new(string name = "mbtrain_valvref_success");
    super.new(name);
endfunction : new
...
task mbtrain_valvref_success::pre_body();
    // tx sequences
    start_tx=mbtrain_valvref_tx_starthandshake::type_id::create("start_tx");
    end_handshake_tx=mbtrain_valvref_tx_endhandshake::type_id::create("end_handshake_tx");
    // rx sequences
...
task mbtrain_valvref_success::body();
    super.body();
    fork
        // tx thread
        begin
