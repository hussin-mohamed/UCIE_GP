...
class mbtrain_datavref_trainerror extends virtual_sequence_base;
    ...
    extern function new(string name = "mbtrain_datavref_trainerror");
...
endclass : mbtrain_datavref_trainerror
...
function mbtrain_datavref_trainerror::new(string name = "mbtrain_datavref_trainerror");
    super.new(name);
endfunction : new
...
task mbtrain_datavref_trainerror::body();
    super.body();
    fork
        // tx thread
        begin
