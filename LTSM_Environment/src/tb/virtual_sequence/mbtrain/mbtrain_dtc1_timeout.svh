...
class mbtrain_dtc1_timeout extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_dtc1_timeout)
    ...
    extern function new(string name = "mbtrain_dtc1_timeout");
...
function mbtrain_dtc1_timeout::new(string name = "mbtrain_dtc1_timeout");
    super.new(name);
endfunction : new
...
task mbtrain_dtc1_timeout::pre_body();
    // tx sequences
...
task mbtrain_dtc1_timeout::body();
    super.body();
    fork
        // tx thread
        begin
