...
class mbtrain_rxdeskew_trainerror extends virtual_sequence_base;
    ...
    extern function new(string name = "mbtrain_rxdeskew_trainerror");
...
function mbtrain_rxdeskew_trainerror::new(string name = "mbtrain_rxdeskew_trainerror");
    super.new(name);
endfunction : new
...
task mbtrain_rxdeskew_trainerror::pre_body();
    // tx sequences
...
task mbtrain_rxdeskew_trainerror::body();
    super.body();
    fork
        // tx thread
        begin
