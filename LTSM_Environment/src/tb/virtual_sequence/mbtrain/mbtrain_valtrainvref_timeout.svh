...
class mbtrain_valtrainvref_timeout extends virtual_sequence_base;
    ...
    extern function new(string name = "mbtrain_valtrainvref_timeout");
...
function mbtrain_valtrainvref_timeout::new(string name = "mbtrain_valtrainvref_timeout");
    super.new(name);
endfunction : new
...
task mbtrain_valtrainvref_timeout::pre_body();
    // tx sequences
...
task mbtrain_valtrainvref_timeout::body();
    super.body();
    fork
        // tx thread
        begin
