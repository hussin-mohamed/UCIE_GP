...
class mbtrain_valtraincenter_trainerror extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_valtraincenter_trainerror)
    mbtrain_valtraincenter_tx_starthandshake      start_tx;
    trainerror_tx_rsp                             error_tx_rsp;
    mbtrain_valtraincenter_rx_starthandshake      start_rx;
    ...
    extern function new(string name = "mbtrain_valtraincenter_trainerror");
...
endclass : mbtrain_valtraincenter_trainerror
...
function mbtrain_valtraincenter_trainerror::new(string name = "mbtrain_valtraincenter_trainerror");
    super.new(name);
endfunction : new
...
task mbtrain_valtraincenter_trainerror::pre_body();
    // tx sequences
...
task mbtrain_valtraincenter_trainerror::body();
    super.body();
    fork
        // tx thread
        begin
