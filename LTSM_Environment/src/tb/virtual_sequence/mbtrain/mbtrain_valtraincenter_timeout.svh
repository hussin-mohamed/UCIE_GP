...
class mbtrain_valtraincenter_timeout extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_valtraincenter_timeout)
    ...
    extern function new(string name = "mbtrain_valtraincenter_timeout");
...
endclass : mbtrain_valtraincenter_timeout
...
function mbtrain_valtraincenter_timeout::new(string name = "mbtrain_valtraincenter_timeout");
    super.new(name);
endfunction : new
...
task mbtrain_valtraincenter_timeout::pre_body();
    // tx sequences
...
task mbtrain_valtraincenter_timeout::body();
    super.body();
    fork
        // tx thread
        begin
