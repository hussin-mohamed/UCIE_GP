...
class mbtrain_linkspeed_repair_fail_0_3_8_15 extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_linkspeed_repair_fail_0_3_8_15)
    ...
    mbtrain_repair_rx_degrade_0_3             apply_rx;
    mbtrain_repair_rx_endhandshake            end_handshake_rx;
    mbtrain_txselfcal_rx_endhandshake         end_repair_rx;
    mbtrain_txinit_datasweep_fail_0_3_8_15    data_sweep;

    // Function: new
    //
    // Creates a new virtual_sequence instance with the given name.

    extern function new(string name = "mbtrain_linkspeed_repair_fail_0_3_8_15");
...
endclass : mbtrain_linkspeed_repair_fail_0_3_8_15
...
function mbtrain_linkspeed_repair_fail_0_3_8_15::new(string name = "mbtrain_linkspeed_repair_fail_0_3_8_15");
    super.new(name);
endfunction : new
...
task mbtrain_linkspeed_repair_fail_0_3_8_15::pre_body();
    // tx sequences
    ...
    apply_rx=mbtrain_repair_rx_degrade_0_3::type_id::create("apply_rx");
    ...
    // datasweep sequence  
    data_sweep=mbtrain_txinit_datasweep_fail_0_3_8_15::type_id::create("data_sweep");
endtask

// body
// ----

task mbtrain_linkspeed_repair_fail_0_3_8_15::body();
    super.body();
    fork
        // tx thread
        begin
