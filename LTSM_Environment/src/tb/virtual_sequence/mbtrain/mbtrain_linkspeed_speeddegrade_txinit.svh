...
class mbtrain_linkspeed_speeddegrade_txinit extends virtual_sequence_base;
    ...
    extern function new(string name = "mbtrain_linkspeed_speeddegrade_txinit");
...
endclass : mbtrain_linkspeed_speeddegrade_txinit
...
function mbtrain_linkspeed_speeddegrade_txinit::new(string name = "mbtrain_linkspeed_speeddegrade_txinit");
    super.new(name);
endfunction : new
...
task mbtrain_linkspeed_speeddegrade_txinit::pre_body();
    // tx sequences
    ...
    // datasweep sequence  
    data_sweep=mbtrain_txinit_datasweep_allfail::type_id::create("data_sweep");
endtask

// body
// ----

task mbtrain_linkspeed_speeddegrade_txinit::body();
    super.body();
    fork
        // tx thread
        begin
