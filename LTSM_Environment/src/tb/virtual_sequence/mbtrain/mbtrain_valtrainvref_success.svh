...
class mbtrain_valtrainvref_success extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_valtrainvref_success)
    mbtrain_valtrainvref_tx_starthandshake        start_tx;
    mbtrain_valtrainvref_tx_endhandshake          end_handshake_tx;
    mbtrain_valtrainvref_rx_starthandshake        start_rx;
    mbtrain_valtrainvref_rx_endhandshake          end_handshake_rx;
    ...
    extern function new(string name = "mbtrain_valtrainvref_success");
...
endclass : mbtrain_valtrainvref_success
...
function mbtrain_valtrainvref_success::new(string name = "mbtrain_valtrainvref_success");
    super.new(name);
endfunction : new
...
task mbtrain_valtrainvref_success::pre_body();
    // tx sequences
    start_tx=mbtrain_valtrainvref_tx_starthandshake::type_id::create("start_tx");
    end_handshake_tx=mbtrain_valtrainvref_tx_endhandshake::type_id::create("end_handshake_tx");
    // rx sequences
    start_rx=mbtrain_valtrainvref_rx_starthandshake::type_id::create("start_rx");
    end_handshake_rx=mbtrain_valtrainvref_rx_endhandshake::type_id::create("end_handshake_rx");
    // datasweep sequence  
...
task mbtrain_valtrainvref_success::body();
    super.body();
    fork
        // tx thread
        begin
