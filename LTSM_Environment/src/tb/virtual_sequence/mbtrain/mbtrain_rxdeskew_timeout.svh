...
class mbtrain_rxdeskew_timeout extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_rxdeskew_timeout)
    ...
    extern function new(string name = "mbtrain_rxdeskew_timeout");
...
endclass : mbtrain_rxdeskew_trainerror
...
function mbtrain_rxdeskew_timeout::new(string name = "mbtrain_rxdeskew_timeout");
    super.new(name);
endfunction : new
...
task mbtrain_rxdeskew_timeout::pre_body();
    // tx sequences
...
task mbtrain_rxdeskew_timeout::body();
    super.body();
    fork
        // tx thread
        begin
