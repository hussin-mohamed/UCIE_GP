...
class mbtrain_linkspeed_phyretrain_nolanepossible_txfail extends virtual_sequence_base;
    ...
    extern function new(string name = "mbtrain_linkspeed_phyretrain_nolanepossible_txfail");
...
endclass : mbtrain_linkspeed_phyretrain_nolanepossible_txfail
...
function mbtrain_linkspeed_phyretrain_nolanepossible_txfail::new(string name = "mbtrain_linkspeed_phyretrain_nolanepossible_txfail");
    super.new(name);
endfunction : new
...
task mbtrain_linkspeed_phyretrain_nolanepossible_txfail::pre_body();
    // tx sequences
    ...
    done_req=mbtrain_linkspeed_rx_endhandshake::type_id::create("done_req");
    end_state=mbtrain_linkspeed_phyretrain_rx::type_id::create("end_handshake_tx");
    // datasweep sequence  
    data_sweep=mbtrain_txinit_datasweep_txallfail_rxpass::type_id::create("data_sweep");
endtask

// body
// ----

task mbtrain_linkspeed_phyretrain_nolanepossible_txfail::body();
    super.body();
    fork
        // tx thread
        begin
