...
class mbtrain_valtrainvref_trainerror extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_valtrainvref_trainerror)
    ...
    extern function new(string name = "mbtrain_valtrainvref_trainerror");
...
function mbtrain_valtrainvref_trainerror::new(string name = "mbtrain_valtrainvref_trainerror");
    super.new(name);
endfunction : new
...
task mbtrain_valtrainvref_trainerror::body();
    super.body();
    fork
        // tx thread
        begin
