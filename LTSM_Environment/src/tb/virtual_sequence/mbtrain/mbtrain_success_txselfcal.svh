...
class mbtrain_success_txselfcal extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_success_txselfcal)
    ...
    extern function new(string name = "mbtrain_success_txselfcal");
...
endclass : mbtrain_success_txselfcal
...
function mbtrain_success_txselfcal::new(string name = "mbtrain_success_txselfcal");
    super.new(name);
endfunction : new
...
task mbtrain_success_txselfcal::pre_body();
    // tx sequences
...
task mbtrain_success_txselfcal::body();
    super.body();
