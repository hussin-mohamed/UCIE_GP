...
class mbtrain_linkspeed_repair_fail_0_7 extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_linkspeed_repair_fail_0_7)
    ...
    extern function new(string name = "mbtrain_linkspeed_repair_fail_0_7");
...
endclass : mbtrain_linkspeed_repair_fail_0_7
...
function mbtrain_linkspeed_repair_fail_0_7::new(string name = "mbtrain_linkspeed_repair_fail_0_7");
    super.new(name);
endfunction : new
...
task mbtrain_linkspeed_repair_fail_0_7::pre_body();
    // tx sequences
    ...
    apply_rx=mbtrain_repair_rx_degrade_8_15::type_id::create("apply_rx");
    ...
    // datasweep sequence  
    data_sweep=mbtrain_txinit_datasweep_fail_0_7::type_id::create("data_sweep");
endtask

// body
// ----

task mbtrain_linkspeed_repair_fail_0_7::body();
    super.body();
    fork
        // tx thread
        begin
