...
class mbtrain_rxinit_datasweep_fail_4_15 extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_rxinit_datasweep_fail_4_15)
    ...
    mbtrain_rxinit_datasweep_tx_result_rsp_fai_4_15  sweep_tx;
    ...
    extern function new(string name = "mbtrain_rxinit_datasweep_fail_4_15");
...
endclass : mbtrain_rxinit_datasweep_fail_4_15
...
function mbtrain_rxinit_datasweep_fail_4_15::new(string name = "mbtrain_rxinit_datasweep_fail_4_15");
    super.new(name);
endfunction : new
...
task mbtrain_rxinit_datasweep_fail_4_15::pre_body();
    // tx sequences
    ...
    sweep_tx=mbtrain_rxinit_datasweep_tx_result_rsp_fai_4_15::type_id::create("sweep_tx");
...
task mbtrain_rxinit_datasweep_fail_4_15::body();
    super.body();
    fork
        // tx thread
        begin
