...
class mbtrain_rxinit_datasweep_success extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_rxinit_datasweep_success)
    ...
    mbtrain_rxinit_datasweep_tx_result_rsp_success  sweep_tx;
    ...
    extern function new(string name = "mbtrain_rxinit_datasweep_success");
...
endclass : mbtrain_rxinit_datasweep_success
...
function mbtrain_rxinit_datasweep_success::new(string name = "mbtrain_rxinit_datasweep_success");
    super.new(name);
endfunction : new
...
task mbtrain_rxinit_datasweep_success::pre_body();
    // tx sequences
    ...
    sweep_tx=mbtrain_rxinit_datasweep_tx_result_rsp_success::type_id::create("sweep_tx");
...
task mbtrain_rxinit_datasweep_success::body();
    super.body();
    fork
        // tx thread
        begin
