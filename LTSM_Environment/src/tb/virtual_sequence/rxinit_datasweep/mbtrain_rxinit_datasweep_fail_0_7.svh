...
class mbtrain_rxinit_datasweep_fail_0_7 extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_rxinit_datasweep_fail_0_7)
    ...
    mbtrain_rxinit_datasweep_tx_result_rsp_fai_0_7  sweep_tx;
    ...
    extern function new(string name = "mbtrain_rxinit_datasweep_fail_0_7");
...
endclass : mbtrain_rxinit_datasweep_fail_0_7
...
function mbtrain_rxinit_datasweep_fail_0_7::new(string name = "mbtrain_rxinit_datasweep_fail_0_7");
    super.new(name);
endfunction : new
...
task mbtrain_rxinit_datasweep_fail_0_7::pre_body();
    // tx sequences
    ...
    sweep_tx=mbtrain_rxinit_datasweep_tx_result_rsp_fai_0_7::type_id::create("sweep_tx");
...
task mbtrain_rxinit_datasweep_fail_0_7::body();
    super.body();
    fork
        // tx thread
        begin
