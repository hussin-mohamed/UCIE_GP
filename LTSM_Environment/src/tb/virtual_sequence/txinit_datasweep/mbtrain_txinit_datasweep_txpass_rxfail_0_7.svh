...
class mbtrain_txinit_datasweep_txpass_rxfail_0_7 extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_txinit_datasweep_txpass_rxfail_0_7)
    ...
    mbtrain_txinit_datasweep_tx_result_rsp_success   end_handshake_tx;
    ...
    extern function new(string name = "mbtrain_txinit_datasweep_txpass_rxfail_0_7");
...
endclass : mbtrain_txinit_datasweep_txpass_rxfail_0_7
...
function mbtrain_txinit_datasweep_txpass_rxfail_0_7::new(string name = "mbtrain_txinit_datasweep_txpass_rxfail_0_7");
    super.new(name);
endfunction : new
...
task mbtrain_txinit_datasweep_txpass_rxfail_0_7::pre_body();
    // tx sequences
    ...
    end_handshake_tx=mbtrain_txinit_datasweep_tx_result_rsp_success::type_id::create("end_handshake_tx");
...
task mbtrain_txinit_datasweep_txpass_rxfail_0_7::body();
    super.body();
