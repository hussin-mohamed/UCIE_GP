...
class mbtrain_txinit_datasweep_txpass_rxallfail extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_txinit_datasweep_txpass_rxfail_8_15)
    ...
    extern function new(string name = "mbtrain_txinit_datasweep_txpass_rxfail_8_15");
...
endclass : mbtrain_txinit_datasweep_txpass_rxfail_8_15
...
function mbtrain_txinit_datasweep_txpass_rxfail_8_15::new(string name = "mbtrain_txinit_datasweep_fail_0_7");
    super.new(name);
endfunction : new
