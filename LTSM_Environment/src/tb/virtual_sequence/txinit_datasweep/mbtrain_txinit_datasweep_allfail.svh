...
class mbtrain_txinit_datasweep_allfail extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_txinit_datasweep_allfail)
    ...
    extern function new(string name = "mbtrain_txinit_datasweep_allfail");
...
endclass : mbtrain_txinit_datasweep_allfail
...
function mbtrain_txinit_datasweep_allfail::new(string name = "mbtrain_txinit_datasweep_allfail");
    super.new(name);
endfunction : new
...
task mbtrain_txinit_datasweep_allfail::pre_body();
    // tx sequences
    start_tx=mbtrain_txinit_datasweep_tx_starthandshake::type_id::create("start_tx");
    ...
    sweep_tx=mbtrain_txinit_datasweep_tx_result_rsp_allfail::type_id::create("sweep_tx");
    end_handshake_tx=mbtrain_txinit_datasweep_tx_end::type_id::create("end_handshake_tx");
    // rx sequences
    ...
    sweep_rx=mbtrain_txinit_datasweep_rx_sweep::type_id::create("sweep_rx");
...
task mbtrain_txinit_datasweep_allfail::body();
    super.body();
    fork
        // tx thread
        begin
