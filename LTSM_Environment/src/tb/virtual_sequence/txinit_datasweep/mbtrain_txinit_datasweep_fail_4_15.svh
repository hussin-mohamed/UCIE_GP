...
class mbtrain_txinit_datasweep_fail_4_15 extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_txinit_datasweep_fail_4_15)
    ...
    mbtrain_txinit_datasweep_tx_result_rsp_fai_4_15   end_handshake_tx;
    ...
    extern function new(string name = "mbtrain_txinit_datasweep_fail_4_15");
...
endclass : mbtrain_txinit_datasweep_fail_4_15
...
function mbtrain_txinit_datasweep_fail_4_15::new(string name = "mbtrain_txinit_datasweep_fail_4_15");
    super.new(name);
endfunction : new
...
task mbtrain_txinit_datasweep_fail_4_15::pre_body();
    // tx sequences
    ...
    end_handshake_tx=mbtrain_txinit_datasweep_tx_result_rsp_fai_4_15::type_id::create("end_handshake_tx");
...
task mbtrain_txinit_datasweep_fail_4_15::body();
    super.body();
