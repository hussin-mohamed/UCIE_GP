...
class mbtrain_txinit_datasweep_txallfail_rxpass extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_txinit_datasweep_txallfail_rxpass)
    ...
    mbtrain_txinit_datasweep_tx_result_rsp_allfail   end_handshake_tx;
    ...
    extern function new(string name = "mbtrain_txinit_datasweep_txallfail_rxpass");
...
endclass : mbtrain_txinit_datasweep_txallfail_rxpass
...
function mbtrain_txinit_datasweep_txallfail_rxpass::new(string name = "mbtrain_txinit_datasweep_txallfail_rxpass");
    super.new(name);
endfunction : new
...
task mbtrain_txinit_datasweep_txallfail_rxpass::pre_body();
    // tx sequences
    ...
    end_handshake_tx=mbtrain_txinit_datasweep_tx_result_rsp_allfail::type_id::create("end_handshake_tx");
...
task mbtrain_txinit_datasweep_txallfail_rxpass::body();
    super.body();
