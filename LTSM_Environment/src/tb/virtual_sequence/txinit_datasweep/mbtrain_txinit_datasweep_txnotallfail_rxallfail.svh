...
class mbtrain_txinit_datasweep_txnotallfail_rxallfail extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_txinit_datasweep_txnotallfail_rxallfail)
    ...
    extern function new(string name = "mbtrain_txinit_datasweep_txnotallfail_rxallfail");
...
endclass : mbtrain_txinit_datasweep_txnotallfail_rxallfail
...
function mbtrain_txinit_datasweep_txnotallfail_rxallfail::new(string name = "mbtrain_txinit_datasweep_txnotallfail_rxallfail");
    super.new(name);
endfunction : new
...
task mbtrain_txinit_datasweep_txnotallfail_rxallfail::pre_body();
    // tx sequences
...
task mbtrain_txinit_datasweep_txnotallfail_rxallfail::body();
    super.body();
