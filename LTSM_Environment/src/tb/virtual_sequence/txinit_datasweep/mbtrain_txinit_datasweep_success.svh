...
class mbtrain_txinit_datasweep_success extends virtual_sequence_base;
    `uvm_object_utils(mbtrain_txinit_datasweep_success)
    ...
    extern function new(string name = "mbtrain_txinit_datasweep_success");
...
endclass : mbtrain_txinit_datasweep_success
...
function mbtrain_txinit_datasweep_success::new(string name = "mbtrain_txinit_datasweep_success");
    super.new(name);
endfunction : new
...
task mbtrain_txinit_datasweep_success::pre_body();
    // tx sequences
...
task mbtrain_txinit_datasweep_success::body();
    super.body();
