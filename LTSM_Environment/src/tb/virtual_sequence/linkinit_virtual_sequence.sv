...
task linkinit_virtual_sequence::pre_body();
    ...
    tx_wake_req_handshake_seq = linkinit_wake_req_handshake::type_id::create("tx_wake_req_handshake_seq");
    tx_state_req_handshake_seq = linkinit_state_req_handshake::type_id::create("tx_state_req_handshake_seq");
    // rx sequences
    rx_clk_req_handshake_seq = linkinit_rx_clk_req_handshake::type_id::create("rx_clk_req_handshake_seq");
    rx_wake_req_handshake_seq = linkinit_wake_req_handshake::type_id::create("rx_wake_req_handshake_seq");
    rx_state_req_handshake_seq = linkinit_state_req_handshake::type_id::create("rx_state_req_handshake_seq");
endtask
...
task linkinit_virtual_sequence::body();
    ...
    fork
        ...
        begin
            ...
            tx_wake_req_handshake_seq.start(ltsm_rdi_sequencer);
            tx_state_req_handshake_seq.start(ltsm_rdi_sequencer);    
        end
        // rx thread
        begin
            rx_clk_req_handshake_seq.start(rx_fsm_sb_seqr);
            rx_wake_req_handshake_seq.start(ltsm_rdi_sequencer);
            rx_state_req_handshake_seq.start(ltsm_rdi_sequencer); 
        end
    join
endtask : body
