...
class mbtrain_txinit_datasweep_tx_result_rsp_fai_4_15 extends uvm_sequence#(tx_fsm_sb_sequence_item);
    `uvm_object_utils(mbtrain_txinit_datasweep_tx_result_rsp_fai_4_15)
    tx_fsm_sb_sequence_item item;
    function new(string name = "mbtrain_txinit_datasweep_tx_result_rsp_fai_4_15");
        super.new(name);
    endfunction //new()
    task body();
