...
class mbtrain_repair_rx_degrade_8_15 extends uvm_sequence#(rx_fsm_sb_sequence_item);
    `uvm_object_utils(mbtrain_repair_rx_degrade_8_15)
    rx_fsm_sb_sequence_item item;
    function new(string name = "mbtrain_repair_rx_degrade_8_15");
        super.new(name);
    endfunction //new()
    task body();
