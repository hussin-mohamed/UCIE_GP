...
class ltsm_mbinit_reversal_result_exit_tx#(string REVERSAL_RESULT = "pass") extends uvm_sequence #(tx_fsm_sb_sequence_item);

  `uvm_object_param_utils(ltsm_mbinit_reversal_result_exit_tx)
  ...
  virtual task body();
    ...
    start_item(tr);
        ...
        case (REVERSAL_RESULT)
          "pass": tr.i_tx_data[15:0] = `RESULT_THRESHOLD +1;
