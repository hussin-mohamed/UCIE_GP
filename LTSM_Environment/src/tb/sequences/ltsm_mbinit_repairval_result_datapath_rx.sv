...
class ltsm_mbinit_repairval_result_datapath_rx#(val_result_t val_result = PASS_VAL) extends uvm_sequence #(LTSM_controllers_seq_item);

  `uvm_object_param_utils(ltsm_mbinit_repairval_result_datapath_rx)


  function new(string name = "ltsm_mbinit_repairval_result_datapath_rx");
    super.new(name);
    val_result = PASS_VAL; // default value
  endfunction

  function new(string name = "ltsm_mbinit_repairval_result_datapath_rx", val_result_t val_result_i);
    super.new(name);
