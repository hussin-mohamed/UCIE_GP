...
class ltsm_mbinit_repairclk_result_exit_tx#(clk_result_t clk_result = PASS) extends uvm_sequence #(tx_fsm_sb_sequence_item);

  `uvm_object_param_utils(ltsm_mbinit_repairclk_result_exit_tx)
