...
class ltsm_mbinit_repairmb_degrage_checking_rx#(degrade_t degrade_code = MATCHED) extends uvm_sequence #(rx_fsm_sb_sequence_item);

  `uvm_object_param_utils(ltsm_mbinit_repairmb_degrage_checking_rx)
