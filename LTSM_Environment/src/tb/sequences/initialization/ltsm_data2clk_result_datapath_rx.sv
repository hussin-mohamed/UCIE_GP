...
class ltsm_data2clk_result_datapath_rx #(parameter lane_results_t lane_result = ALL_LANES_FUNCTIONAL) extends uvm_sequence #(LTSM_controllers_seq_item);

  `uvm_object_param_utils(ltsm_data2clk_result_datapath_rx#(lane_result))
