...
class ltsm_sb_tx_done_resp extends uvm_sequence #(tx_fsm_sb_sequence_item);

  `uvm_object_utils(ltsm_sb_tx_done_resp)

  function new(string name = "ltsm_sb_tx_done_resp");
    super.new(name);
  endfunction
