...
class ltsm_mbinit_reversal_result_data_path_rx#(parameter string REVERSAL_PASS = "pass") extends uvm_sequence #(LTSM_controllers_seq_item);
  ...
  virtual task body();
    ...
    start_item(tr);
        case (REVERSAL_PASS)
            "pass": tr.i_rx_data_results[15:0] = `RESULT_THRESHOLD ;
