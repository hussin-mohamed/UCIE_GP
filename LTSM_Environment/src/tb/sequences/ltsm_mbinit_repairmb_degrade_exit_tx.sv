...
class ltsm_mbinit_repairmb_degrade_exit_tx#(lane_results_t lane_results = ALL_LANES_FUNCTIONAL) extends uvm_sequence #(tx_fsm_sb_sequence_item);

  `uvm_object_param_utils(ltsm_mbinit_repairmb_degrade_exit_tx)
