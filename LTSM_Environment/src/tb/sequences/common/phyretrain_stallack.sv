...
class phyretrain_stallack extends uvm_sequence#(ltsm_rdi_sequence_item);
    `uvm_object_utils(phyretrain_stallack)
    ltsm_rdi_sequence_item item;
    
    function new(string name = "phyretrain_stallack");
        super.new(name);
    endfunction //new()
