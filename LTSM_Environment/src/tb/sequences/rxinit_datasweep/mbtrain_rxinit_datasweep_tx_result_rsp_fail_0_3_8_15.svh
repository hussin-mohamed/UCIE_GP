...
class mbtrain_rxinit_datasweep_tx_result_rsp_fai_0_3_8_15 extends uvm_sequence#(tx_fsm_sb_sequence_item);
    `uvm_object_utils(mbtrain_rxinit_datasweep_tx_result_rsp_fai_0_3_8_15)
    tx_fsm_sb_sequence_item item;
    function new(string name = "mbtrain_rxinit_datasweep_tx_result_rsp_fai_0_3_8_15");
        super.new(name);
    endfunction //new()
    task body();
