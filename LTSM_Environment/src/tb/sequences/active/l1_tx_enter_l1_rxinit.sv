...
class l1_tx_enter_l1_rxinit extends uvm_sequence#(tx_fsm_sb_sequence_item);
    `uvm_object_utils(l1_tx_enter_l1_rxinit)
    tx_fsm_sb_sequence_item item;
    
    function new(string name = "l1_tx_enter_l1_rxinit");
        super.new(name);
    endfunction //new()
