...
class mbtrain_datasweep_tx_result_rsp_success extends uvm_sequence#(tx_fsm_sb_sequence_item);
    `uvm_object_utils(mbtrain_datasweep_tx_result_rsp_success)
    tx_fsm_sb_sequence_item item;
    function new(string name = "mbtrain_datasweep_tx_result_rsp_success");
        super.new(name);
    endfunction //new()
    task body();
