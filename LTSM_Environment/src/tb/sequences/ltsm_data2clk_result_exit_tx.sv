...
class ltsm_data2clk_result_exit_tx #(lane_results_t lane_result = ALL_LANES_FUNCTIONAL ) extends uvm_sequence #(tx_fsm_sb_sequence_item);

  `uvm_object_param_utils(ltsm_data2clk_result_exit_tx)
