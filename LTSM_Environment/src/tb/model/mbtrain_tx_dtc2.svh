...
class mbtrain_tx_dtc2 extends state;
    ...
    virtual function bit doSpecificCombAction(FSMContext cntxt,LTSM_controllers_sequence_item item_controllers_in,ltsm_rdi_sequence_item item_rdi_in,rx_fsm_sb_sequence_item item_rx_fsm_sb_in,tx_fsm_sb_sequence_item item_tx_fsm_sb_in,
        ...
        if(item_tx_fsm_sb_in.i_tx_decoding == MBTRAIN_VALTRAINVREF_TX_End_Handshake && item_rx_fsm_sb_in.i_rx_decoding == RX_MBTRAIN_VALTRAINVREF_End_Handshake && item_tx_fsm_sb_in.i_sb_tx_rsp==1'b1 && cntxt.currentstate_tx == mbtrain_tx_valtrainvref::Instance())begin
            ...
            if (o_tx_encoding_expected==item_tx_fsm_sb_out.o_tx_encoding && o_tx_info_expected==item_tx_fsm_sb_out.o_tx_info && o_sb_tx_rsp_expected == item_tx_fsm_sb_out.o_sb_tx_rsp && o_tx_data_expected == item_tx_fsm_sb_out.o_tx_data ) begin
                ...
                `uvm_info("mbtrain_tx_dtc2", $sformatf("o_tx_info mismatch expected value: %0h, got %0h", o_tx_info_expected, item_tx_fsm_sb_out.o_tx_info), UVM_LOW)
                `uvm_info("mbtrain_tx_dtc2", $sformatf("o_sb_tx_req mismatch expected value: %0b, got %0b", o_sb_tx_req_expected, item_tx_fsm_sb_out.o_sb_tx_req), UVM_LOW)
                `uvm_info("mbtrain_tx_dtc2", $sformatf("Mismatch in o_tx_encoding: expected %0h, got %0h", o_tx_data_expected, item_tx_fsm_sb_out.o_tx_data), UVM_LOW)
            end
        end
