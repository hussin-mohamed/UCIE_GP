...
class mbtrain_tx_datavref extends state;
    ...
    virtual function bit doSpecificCombAction(FSMContext cntxt,LTSM_controllers_sequence_item item_controllers_in,ltsm_rdi_sequence_item item_rdi_in,rx_fsm_sb_sequence_item item_rx_fsm_sb_in,tx_fsm_sb_sequence_item item_tx_fsm_sb_in,
        ...
        if(item_tx_fsm_sb_in.i_tx_decoding == MBTRAIN_VALVREF_TX_End_Handshake && item_rx_fsm_sb_in.i_rx_decoding == RX_MBTRAIN_VALVREF_End_Handshake && item_tx_fsm_sb_in.i_sb_tx_rsp==1'b1 && cntxt.currentstate_tx == mbtrain_tx_valvref::instance())begin
            ...
            if (o_tx_encoding_expected==item_tx_fsm_sb_out.o_tx_encoding && o_tx_info_expected==item_tx_fsm_sb_out.o_tx_info && o_sb_tx_req_expected == item_tx_fsm_sb_out.o_sb_tx_req) begin
                ...
                `uvm_info("mbtrain_tx_datavref", $sformatf("o_sb_tx_req mismatch expected value: %0b, got %0b", o_sb_tx_req_expected, item_tx_fsm_sb_out.o_sb_tx_req), UVM_LOW)
            end
        end
        else if((item_tx_fsm_sb_in.i_tx_decoding == MBTRAIN_DATAVREF_TX_Start_Handshake && item_tx_fsm_sb_in.i_sb_tx_rsp==1'b1 && cntxt.currentstate_tx == mbtrain_tx_datavref::instance()) || 
             ...
             o_tx_encoding_expected = MBTRAIN_DATAVREF_TX_Pattern_Generation;
        ...
        else if (item_controllers_in.i_tx_done && cntxt.currentstate_tx == mbtrain_tx_datavref::instance()) begin
