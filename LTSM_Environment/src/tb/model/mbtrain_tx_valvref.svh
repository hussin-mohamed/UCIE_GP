...
class mbtrain_tx_valvref extends state;
    ...
    virtual function bit doSpecificCombAction(FSMContext cntxt,LTSM_controllers_sequence_item item_controllers_in,ltsm_rdi_sequence_item item_rdi_in,rx_fsm_sb_sequence_item item_rx_fsm_sb_in,tx_fsm_sb_sequence_item item_tx_fsm_sb_in,
        ...
        if(item_tx_fsm_sb_in.i_tx_decoding == MBINIT_REPAIRMB_TX_Done_Handshake && item_rx_fsm_sb_in.i_rx_decoding == RX_MBINIT_REPAIRMB_Done_Handshake && item_tx_fsm_sb_in.i_sb_tx_rsp==1'b1 && cntxt.currentstate_tx == mbinit_tx_repairmb::instance())begin
        ...
        else if((item_tx_fsm_sb_in.i_tx_decoding == MBTRAIN_VALVREF_TX_Start_Handshake && item_tx_fsm_sb_in.i_sb_tx_rsp==1'b1 && cntxt.currentstate_tx == mbtrain_tx_valvref::instance()) || 
        (item_tx_fsm_sb_in.i_tx_decoding == Data_To_Clock_sweep_TX_End_Init_Handshake && item_tx_fsm_sb_in.i_sb_tx_rsp==1'b1 && item_tx_fsm_sb_in.i_tx_info[4] == 1'b0 && cntxt.currentstate_tx == data_to_clock_sweep::instance() ))begin
             o_tx_encoding_expected = MBTRAIN_VALVREF_TX_Pattern_Generation;
        ...
        else if (item_controllers_in.i_tx_done && cntxt.currentstate_tx == mbtrain_tx_valvref::instance()) begin
