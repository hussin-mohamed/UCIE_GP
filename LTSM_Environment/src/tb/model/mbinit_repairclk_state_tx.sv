...
class MbInitRepairClkState_tx extends State;
   ...
   virtual function bit doSpecificCombAction(FSMContext cntxt,LTSM_controllers_sequence_item item_controllers_in,ltsm_rdi_sequence_item item_rdi_in,rx_fsm_sb_sequence_item item_rx_fsm_sb_in,tx_fsm_sb_sequence_item item_tx_fsm_sb_in,
      ...
      if(cntxt.current_state_tx == MbInitCalState_tx::Instance() && item_controllers_in.i_tx_decoding == MBINIT_CAL_TX_Done_Handshake && item_tx_fsm_sb_in.i_sb_tx_done == 1'b1) begin
      ...
      else if(item_tx_fsm_sb_in.i_sb_tx_rsp == 1'b1 && item_controllers_in.i_tx_decoding == 'h22 && item_tx_fsm_sb_in.i_tx_data == ERROR_DETECTED) begin
      ...
      else if(item_tx_fsm_sb_in.i_sb_tx_rsp == 1'b1 && item_controllers_in.i_tx_decoding == 'h22 && item_tx_fsm_sb_in.i_tx_data == NO_ERRORS) begin
