...
class StateTransitionUtil_rx extends uvm_object;
 `uvm_object_utils(StateTransitionUtil_rx)
 ...
 static function void init();
    ...
    validStateTransitions[mbtrain_rx_valvref::Instance()] = { mbtrain_rx_valvref::Instance(), data_to_clock_sweep::Instance(), mbtrain_rx_datavref::Instance(), trainerror_rx::Instance(), ResetState_rx::Instance()};
    
    validStateTransitions[mbtrain_rx_datavref::Instance()] = { mbtrain_rx_datavref::Instance(), data_to_clock_sweep::Instance(), mbtrain_rx_speedidle::Instance(), trainerror_rx::Instance(), ResetState_rx::Instance()};
    ...
    validStateTransitions[mbtrain_rx_valtraincenter::Instance()] = { mbtrain_rx_valtraincenter::Instance(), data_to_clock_sweep::Instance(), mbtrain_rx_valtrainvref::Instance(), trainerror_rx::Instance(), ResetState_rx::Instance()};

    validStateTransitions[mbtrain_rx_valtrainvref::Instance()] = { mbtrain_rx_valtrainvref::Instance(), data_to_clock_sweep::Instance(), mbtrain_rx_dtc1::Instance(), trainerror_rx::Instance(), ResetState_rx::Instance()};
    
    validStateTransitions[mbtrain_rx_dtc1::Instance()] = { mbtrain_rx_dtc1::Instance(), data_to_clock_sweep::Instance(), mbtrain_rx_datatrainvref::Instance(), trainerror_rx::Instance(), ResetState_rx::Instance()};
    
    validStateTransitions[mbtrain_rx_datatrainvref::Instance()] = { mbtrain_rx_datatrainvref::Instance(), data_to_clock_sweep::Instance(), mbtrain_rx_rxdeskew::Instance(), trainerror_rx::Instance(), ResetState_rx::Instance()};
    
    validStateTransitions[mbtrain_rx_rxdeskew::Instance()] = { mbtrain_rx_rxdeskew::Instance(), data_to_clock_sweep::Instance(), mbtrain_rx_dtc2::Instance(), trainerror_rx::Instance(), ResetState_rx::Instance()};
    
    validStateTransitions[mbtrain_rx_dtc2::Instance()] = { mbtrain_rx_dtc2::Instance(), data_to_clock_sweep::Instance(), mbtrain_rx_linkspeed::Instance(), trainerror_rx::Instance(), ResetState_rx::Instance()};
    
    validStateTransitions[mbtrain_rx_linkspeed::Instance()] = { mbtrain_rx_linkspeed::Instance(), data_to_clock_sweep::Instance(), mbtrain_rx_repair::Instance(), phyretrain_rx::Instance(), linkinit_state_rx::Instance(), trainerror_rx::Instance(), ResetState_rx::Instance()};
  ...
  static function State calculateNextState(FSMContext cntxt,LTSM_controllers_sequence_item item_controllers_in,ltsm_rdi_sequence_item item_rdi_in,rx_fsm_sb_sequence_item item_rx_fsm_sb_in,tx_fsm_sb_sequence_item item_tx_fsm_sb_in);
        case (cntxt.currentState_rx.getStateId())
            ...
            fsm_mbtrain_rx_valvref : begin
               ...
               else if(item_rx_fsm_sb_in.i_sb_rx_done == 1 && )begin
