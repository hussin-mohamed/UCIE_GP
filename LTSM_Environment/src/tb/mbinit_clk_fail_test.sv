...
class mbinit_clk_fail_test extends uvm_test;
    `uvm_component_utils(mbinit_clk_fail_test)

    LTSM_env env;
    env_config env_cfg;
    uvm_factory factory;
    // sequence to run
    ltsm_init_clk_fail_v_sequence init_seq;

    // Function: new
    //
    // Creates a new mbinit_clk_fail_test instance and retrieves factory singleton handle.

    extern function new(string name = "mbinit_clk_fail_test", uvm_component parent = null);
...
function mbinit_clk_fail_test::new(string name = "mbinit_clk_fail_test", uvm_component parent = null);
...
function void mbinit_clk_fail_test::build_phase(uvm_phase phase);
    super.build_phase(phase);
    // Create the sequence
    init_seq = ltsm_init_clk_fail_v_sequence::type_id::create("init_seq", this);
...
function void mbinit_clk_fail_test::end_of_elaboration_phase(uvm_phase phase);
...
function void mbinit_clk_fail_test::start_of_simulation_phase(uvm_phase phase);
...
task mbinit_clk_fail_test::run_phase(uvm_phase phase);
...
function void mbinit_clk_fail_test::final_phase(uvm_phase phase);
