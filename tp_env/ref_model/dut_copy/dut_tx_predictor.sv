...
//=============================================================================
  ...
  import dut_B2L_modelling_pkg::*;
  import dut_LFSR_modelling_pkg::*;
  import dut_per_lane_id_modelling_pkg::*;

  class dut_tx_predictor;
    ...
    static task  predict (
      ...
      input  logic        lfsr_disable,
      input  logic [7:0]  i_lp_data [0:NBYTES-1],
      output logic [dut_B2L_modelling_pkg::DATA_WIDTH-1:0] o_lane [0:dut_B2L_modelling_pkg::LANES_NUMBER-1]
    );
      ...
      logic [dut_B2L_modelling_pkg::DATA_WIDTH-1:0] o_lane_b2l [0:dut_B2L_modelling_pkg::LANES_NUMBER-1];
      logic [dut_B2L_modelling_pkg::DATA_WIDTH-1:0] o_lane_lfsr [0:dut_B2L_modelling_pkg::LANES_NUMBER-1];
      logic [dut_B2L_modelling_pkg::DATA_WIDTH-1:0] o_lane_per_lane_id [0:dut_B2L_modelling_pkg::LANES_NUMBER-1];

    dut_tx_controller_modelling(
      controller_state,
      i_reset,
      i_tx_encoding,
      i_lane_map_code,
