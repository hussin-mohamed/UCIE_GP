...
class tx_coverage extends uvm_component;
  ...
  covergroup cg_ltsm;
    ...
    cp_encoding: coverpoint curr_encoding {
      ...
      bins repairmb[] = {REPAIRMB_INIT_HND, REPAIRMB_APPLY_DEGRADE_HND, REPAIRMB_DONE_HND};
      ...
      // Phase 10: Active
      bins linkinit[] = {LINKINIT_PL_CLK_REQ_HND, LINKINIT_LP_WAKE_REQ_HND, LINKINIT_STATE_REQ_HND};
      bins active = {ACTIVE};
  ...
  function ltsm_state_e encoding_to_state(ltsm_encoding_e enc);
    case (enc)
      ...
      REPAIRCLK_INIT_HND, REPAIRCLK_CLK_PATTERN_GEN, REPAIRCLK_RESULT_HND, REPAIRCLK_DONE_HND:
      return ST_REPAIRCLK;
      REPAIRVAL_INIT_HND, REPAIRVAL_VALID_PATTERN_GEN, REPAIRVAL_RESULT_HND, REPAIRVAL_DONE_HND:
      return ST_REPAIRVAL;
      REVERSAL_INIT_HND, REVERSAL_CLEAR_LOG_HND,
        REVERSAL_PER_LANE_ID_GEN, REVERSAL_RESULT_HND,
        REVERSAL_APPLY, REVERSAL_DONE_HND:
      return ST_REVERSAL;
      REPAIRMB_INIT_HND, REPAIRMB_APPLY_DEGRADE_HND, REPAIRMB_DONE_HND: return ST_REPAIRMB;
      ...
      LINKINIT_PL_CLK_REQ_HND, LINKINIT_LP_WAKE_REQ_HND, LINKINIT_STATE_REQ_HND: return ST_LINKINIT;
