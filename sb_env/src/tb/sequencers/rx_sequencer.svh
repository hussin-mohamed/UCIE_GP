...
// CLASS: rx_sequencer
//
// Sideband RX sequencer for managing transaction flow on the RX interface.
//
//-----------------------------------------------------------------------------
...
class rx_sequencer extends uvm_sequencer #(ltsm_seq_item);
  ...
  uvm_analysis_export #(ltsm_seq_item) reactive_exp;
  uvm_tlm_analysis_fifo #(ltsm_seq_item) reactive_fifo;
