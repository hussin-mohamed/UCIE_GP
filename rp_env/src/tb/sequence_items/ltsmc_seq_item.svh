...
class ltsmc_seq_item extends uvm_sequence_item;
  ...
  `uvm_object_utils_begin(ltsmc_seq_item)
    ...
    `uvm_field_int(rx_clk_results, UVM_DEFAULT | UVM_NORECORD | UVM_NOPACK | UVM_NOCOMPARE)
    `uvm_field_int(rx_valid_results, UVM_DEFAULT | UVM_NORECORD | UVM_NOPACK | UVM_NOCOMPARE)
