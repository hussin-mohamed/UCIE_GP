module pattern_generation (
    ...
    output logic        o_clk,         // Gated output clock phase 1
    output logic        o_clk_p,       // Gated output clock phase 2
    ...
    always @(*) begin
        ...
        if (i_halfrate) begin
            ...
            o_clk = i_hclk & w_henable;
            o_clk_p = ~o_clk; // to produce 180 phase difference
        end else begin
            ...
            o_clk = w_qclk_1 & w_qenable_1;
            o_clk_p = w_qclk_2 & w_qenable_2;
