...
class tx_fsm_sb_sequence_item extends uvm_sequence_item;
    ...
    `uvm_object_utils_begin(tx_fsm_sb_sequence_item)
        ...
        `uvm_field_int(i_sb_tx_req,     UVM_NORECORD)
        `uvm_field_int(i_sb_tx_rsp,     UVM_NORECORD)
        `uvm_field_int(i_sb_tx_done,    UVM_NORECORD)
        `uvm_field_int(o_tx_sb_req,     UVM_NORECORD)
        `uvm_field_int(o_tx_sb_rsp,     UVM_NORECORD)
        `uvm_field_int(o_tx_sb_done,    UVM_NORECORD)
