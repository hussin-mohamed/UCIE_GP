...
class LTSM_controllers_monitor #(type LTSM_controllers_seq_item, type LTSM_controllers_if)
 extends LTSM_monitor_base #(LTSM_controllers_seq_item, LTSM_controllers_if);
    `uvm_component_param_utils(LTSM_controllers_monitor #(LTSM_controllers_seq_item, LTSM_controllers_if))
...
task LTSM_controllers_monitor::collect_transaction();
    ...
    // Align to LTSM_controllers clock
